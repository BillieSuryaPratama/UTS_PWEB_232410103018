<div style="background-color: #555555;" class="text-center mt-3 px-6 py-3 grid grid-cols-2 gap-8">
    <div class="flex flex-col items-center justify-center">
        ...
        <p class="text-sm text-gray-300">
            PlayLog is a game information website that provides curated game lists and detailed descriptions for gamers.
        </p>
    </div>
    <div>
        <h3 style="color: #0cbd66;" class="text-lg font-semibold mb-2">Company</h3>
