...
<body style="background-color: #333333;" class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div style="background-color: #555555;" class="w-full max-w-sm p-8 rounded shadow-2xl">
        ...
        <form action="{{ route('login.Autentikasi') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="username" required class="w-full border border-gray-300 p-2 rounded focus:outline-none focus:ring-2 focus:ring-[#0cbd66]">
            </div>
            <div>
                <p class="block mb-1 text-white">Password</p>
                <input type="password" name="password" required class="w-full border border-gray-300 p-2 rounded focus:outline-none focus:ring-2 focus:ring-[#0cbd66]">
            </div>
